...
export function AgentBuilder() {
  ...
  return (
    <DndProvider backend={HTML5Backend}>
      <ReactFlowProvider>
        <div className="relative flex h-full w-full min-w-0 min-h-0 overflow-hidden">
          ...
          <aside className="hidden xl:flex h-full min-h-0 w-96 shrink-0 border-l bg-sidebar p-0 flex-col overflow-hidden">
            <RightPanelContent
              rightTab={rightTab}
