---
title: Reference
description: Glossary, service catalog, schema pointers, limits, versions.
order: 7
---

# Reference

Lookup material — definitions, catalogs, links to authoritative schema sources, and version compatibility.

## Pages

- [Glossary](./glossary.md) — every term used in the docs and the product.
