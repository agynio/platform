...
- When `ZITI_ENABLED=true`, platform-server launches a local proxy on `127.0.0.1:17071` backed by the OpenZiti Node SDK and docker-runner binds the same API to the OpenZiti service (`dev.agyn-platform.platform-api`).
