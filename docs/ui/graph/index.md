...
- Required environment variables:
  ...
  - VITE_SOCKET_BASE_URL: Socket.IO base URL (use the notifications-gateway origin — `http://localhost:4000` locally; the client connects to `/socket.io` with websocket transport only)
