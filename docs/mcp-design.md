...
- Consistent success formatting: On successful tool calls, `structuredContent` is formatted uniformly as YAML across Agent call sites to keep downstream output stable.
