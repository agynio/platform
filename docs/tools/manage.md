...
Purpose: Manage connected agents from a parent agent. Supports sending a message to a specific worker using isolated child threads and checking status of active child threads for the current parent thread.
